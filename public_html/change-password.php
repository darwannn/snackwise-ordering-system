...
<div class="input-container">
                    <input type="password" class="current_password" name="current_password" id="current_password"
                        placeholder="Retype Password" value="" autocomplete="off">
                    <i class="fa-solid fa-eye-slash toggler" id="current_password_toggler" for="current_password"
                ...
                <div class="input-container">
                    ...
                    <span class="input_error" id="retype_password_error" class="text-danger"></span>
                                    ...
                                    <button type="button" id="change_password" class="btn btn-outline-danger update-btn" onclick="new Account().change_password();"> Change Passwordd</button>
                    </form>
