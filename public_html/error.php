            ...
            <div class="content">
                <div class="snackwise-label">
                    <div class="brand-icon">
                        <img src="img/penguin2.png" class="snackwise-icon" alt="Snackwise Logo">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-grid gap-2">
                                <button type="button" name="" id="" class="btn btn-warning return-btn" onclick="location.href='index.php'">Back to Home Page</button>
                            </div>  
                        </div>
                    </div>
                </section>           
